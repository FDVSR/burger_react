...
export const orderRequestAsynk = createAsyncThunk(
    'order/fetch',
    (_, {getState}) => {
...
const orderSlice = createSlice({
    ...
    extraReducers: builder => {
        builder
            .addCase(orderRequestAsynk.pending , (state) => {
                state.error='';
            })
            .addCase(orderRequestAsynk.fulfilled , (state, action) => {
            ...
            .addCase(orderRequestAsynk.rejected , (state, action) => {
